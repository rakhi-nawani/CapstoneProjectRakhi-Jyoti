...
import com.trilogyed.retailedgeservice.exception.NotFoundException;
...
public class ControllerExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
    public ResponseEntity<VndErrors> NotFoundExceptionException(NotFoundException e, WebRequest request) {
